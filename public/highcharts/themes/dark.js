...
(function (a) {
  ...
  b(a, 'themes/dark-unica.js', [a['parts/Globals.js']], function (a) {
    ...
    a.theme = {
      //colors: ['#ff8000', '#26d07c', '#ffc72c', '#ff671f', '#ff0000' ], // '#2b908f #90ee7e #f45b5b #7798BF #aaeeee #ff0066 #eeaaee #55BF3B #DF5353 #7798BF #aaeeee'.split(' '),
      colors: [
        $nuxt.$vuetify.theme.currentTheme.primary,
        $nuxt.$vuetify.theme.currentTheme.success,
        $nuxt.$vuetify.theme.currentTheme.info,
        $nuxt.$vuetify.theme.currentTheme.warning,
        $nuxt.$vuetify.theme.currentTheme.error
      ],
      chart: {
        backgroundColor: {
          linearGradient: {
