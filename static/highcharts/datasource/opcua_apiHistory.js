...
(function (win) {
  ...
  console.log('using opUA_apiHistory as datasource for trend')
  /**
	 * @alias module:opcUAData
	 */
  const opcUA = Datasource.register('opcUA_apiHistory', function () {
  ...
  opcUA.prototype._loadPoints = function (options, callback) {
    ...
    function validateAggregateOptions (options) {
      ...
      for (const i in options) {
        ...
        const unit = options[i].unit.toUpperCase()
        const validUnits = ['s', 'm', 'h', 'H', 'M', 'S']
