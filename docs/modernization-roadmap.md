...
- Includes: baseline styling, proxy defaults for `/webmi`, `/customScripts`, `/vueComponents`, a migration status page, and a
  shared `useAtviseProxy` composable exposed in the default layout.
